    ...
    <div class="container">
        ...
        ?>
            <div class="col-md-4">
                ...
                <a type="button" class="btn btn-outline-primary" href="?c=prispevky&a=uprav&id=<?=$article->getId() ?>">
                ...
                <a type="button" class="btn btn-outline-danger" href="?c=prispevky&zmaz=true&id=<?=$article->getId() ?>">
